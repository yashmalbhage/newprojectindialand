...
export const list = [
  {
    id: 1,
    cover: "../images/Chennai/1.jpg",
    name: "INDIALAND INDUSTRIAL AND LOGISTIC PARK ORAGADAM",
    location: "Chennai",
    // category: "For Rent",
    price: "Know more",
    link:'/Chennai'
...
export const awards = [
  {
    ...
    num: "32+	",
    name: "MILLION SQFT OF TENANTED SPACE",
  },
  {
    icon: <i class='fa-solid fa-briefcase'></i>,
    num: "50+",
    name: "MULTINATIONAL CLIENTS",
  },
